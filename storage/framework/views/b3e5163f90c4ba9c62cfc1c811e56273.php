<?php $__env->startSection('title', 'Gestion des Demandes de Retrait'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-striped dt-responsive nowrap w-100" id="retraits-table">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $retraits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $retrait): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <span class="fw-semibold"><?php echo e($retrait->date_demande->format('d/m/Y')); ?></span>
                                        <br>
                                        <small class="text-muted"><?php echo e($retrait->date_demande->format('H:i')); ?></small>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm bg-primary rounded-circle me-2">
                                                <span class="avatar-title text-white"><?php echo e(substr($retrait->adherent->prenom, 0, 1)); ?></span>
                                            </div>
                                            <div>
                                                <h6 class="mb-0"><?php echo e($retrait->adherent->nom_complet); ?></h6>
                                                <small class="text-muted"><?php echo e($retrait->adherent->email); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="fw-semibold text-danger"><?php echo e(number_format($retrait->montant_demande, 0, ',', ' ')); ?> FCFA</span>
                                    </td>
                                    <td>
                                        <span class="badge bg-info"><?php echo e(ucfirst($retrait->type_retrait)); ?></span>
                                    </td>
                                    <td>
                                        <span class="text-muted"><?php echo e(ucfirst(str_replace('_', ' ', $retrait->mode_retrait))); ?></span>
                                    </td>
                                    <td>
                                        <?php switch($retrait->statut):
                                            case ('validé'): ?>
                                            ...
                                            <?php case ('traité'): ?>
                                                ...
                                                <?php break; ?>
                                            <?php default: ?>
                                                <span class="badge bg-light text-dark"><?php echo e(ucfirst($retrait->statut)); ?></span>
                                        <?php endswitch; ?>
                                    </td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('admin.retraits.show', $retrait)); ?>" class="btn btn-sm btn-outline-primary" title="Voir">
                                                <i class="mdi mdi-eye"></i>
                                            </a>
                                            <?php if($retrait->statut === 'en_attente'): ?>
                                            <button type="button" class="btn btn-sm btn-outline-success"
                                                    onclick="validateRetrait(<?php echo e($retrait->id); ?>)" title="Valider">
                                                <i class="mdi mdi-check"></i>
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-danger"
                                                    onclick="rejectRetrait(<?php echo e($retrait->id); ?>)" title="Rejeter">
                                                <i class="mdi mdi-close"></i>
                                            </button>
                                            <?php endif; ?>
                                            <?php if($retrait->statut === 'validé'): ?>
                                            <button type="button" class="btn btn-sm btn-outline-primary"
                                                    onclick="processRetrait(<?php echo e($retrait->id); ?>)" title="Traiter">
                    ...
                    <?php if($retraits->hasPages()): ?>
                    <div class="row">
                        <div class="col-sm-12 col-md-5">
                            <div class="dataTables_info">
                                Affichage de <?php echo e($retraits->firstItem()); ?> à <?php echo e($retraits->lastItem()); ?> sur <?php echo e($retraits->total()); ?> résultats
                            </div>
                        </div>
...
<?php echo $__env->make('backoffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Mes Sites Web\sif-project\resources\views/backoffice/retraits/index.blade.php ENDPATH**/ ?>
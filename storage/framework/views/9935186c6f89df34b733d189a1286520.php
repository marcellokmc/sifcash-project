...
<?php $__env->startSection('title', $plan->nom . ' - Détail du Plan'); ?>
...
<div class="container py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('adherent.dashboard')); ?>" class="text-decoration-none">
                    <i class="fas fa-home me-1"></i>Tableau de bord
                </a>
            </li>
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('adherent.plans.index')); ?>" class="text-decoration-none">Plans disponibles</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page"><?php echo e($plan->nom); ?></li>
        </ol>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-auto">
                            <span class="badge bg-light text-dark fs-6 px-3 py-2">
                                <?php echo e($plan->taux_interet); ?>% d'intérêt
                            </span>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <p class="card-text fs-6"><?php echo e($plan->description); ?></p>
                </div>
            </div>
                            ...
                            <div class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p class="text-muted mb-0">
                                        Entre <?php echo e(number_format($plan->montant_min, 0, ',', ' ')); ?> FCFA 
                                        et <?php echo e(number_format($plan->montant_max, 0, ',', ' ')); ?> FCFA
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p class="text-muted mb-0"><?php echo e(ucfirst($plan->periodicite)); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p class="text-muted mb-0"><?php echo e($plan->taux_interet); ?>% par période</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p class="text-muted mb-0"><?php echo e($plan->duree_min_jours); ?> jours d'engagement</p>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
            ...
            <!-- Conditions et frais -->
            <?php if($plan->frais_adhesion > 0 || $plan->frais_retrait > 0 || $plan->conditions): ?>
            <div class="card mb-4">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center p-3 bg-light rounded">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted"><?php echo e(number_format($plan->frais_adhesion, 0, ',', ' ')); ?> FCFA</div>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center p-3 bg-light rounded">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted"><?php echo e(number_format($plan->frais_retrait, 0, ',', ' ')); ?> FCFA</div>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                    ...
                    <form id="simulatorForm" class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="montant_simule" 
                                   min="<?php echo e($plan->montant_min); ?>" max="<?php echo e($plan->montant_max); ?>" 
                                   value="<?php echo e($plan->montant_min); ?>" step="1000">
                        </div>
                        <div class="col-md-6">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        <div class="h4 text-primary"><?php echo e($mesAdhesions->count()); ?></div>
                        <div class="text-muted small">Adhésion(s) à ce plan</div>
                    </div>
                    
                    <?php $__currentLoopData = $mesAdhesions->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adhesion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex justify-content-between align-items-center mb-2 p-2 bg-light rounded">
                            <div>
                                <div class="fw-semibold"><?php echo e(number_format($adhesion->montant, 0, ',', ' ')); ?> FCFA</div>
                                <small class="text-muted"><?php echo e($adhesion->created_at->format('d/m/Y')); ?></small>
                            </div>
                            <span class="badge bg-<?php echo e($adhesion->statut === 'active' ? 'success' : 'warning'); ?>">
                    ...
                    <?php if($mesAdhesions->count() > 3): ?>
                        <small class="text-muted">et <?php echo e($mesAdhesions->count() - 3); ?> autre(s)...</small>
                    <?php endif; ?>

                    <div class="d-grid gap-2 mt-3">
                        <a href="<?php echo e(route('adherent.adhesions.index', ['plan' => $plan->id])); ?>" class="btn btn-outline-info btn-sm">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <?php if($mesAdhesions->where('statut', 'active')->count() === 0): ?>
                            <a href="<?php echo e(route('adherent.adhesions.create', ['plan' => $plan->id])); ?>" class="btn btn-primary">
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('adherent.adhesions.create', ['plan' => $plan->id])); ?>" class="btn btn-outline-primary">
                                <i class="fas fa-plus-circle me-2"></i>Nouvelle adhésion
                            </a>
                        <?php endif; ?>
                        
                        <a href="<?php echo e(route('adherent.plans.index')); ?>" class="btn btn-outline-secondary">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-6">
                            <div class="h5 text-success"><?php echo e($plan->adhesions_count ?? $plan->adhesions->count()); ?></div>
                            <small class="text-muted">Adhérents</small>
                        </div>
                        <div class="col-6">
                            <div class="h5 text-info"><?php echo e(number_format($plan->adhesions->sum('montant'), 0, ',', ' ')); ?> FCFA</div>
                    ...
                    <small class="text-muted">
                        ...
                        Rejoignez <?php echo e($plan->adhesions->count()); ?> autre(s) adhérent(s) sur ce plan
                    </small>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const tauxInteret = <?php echo e($plan->taux_interet); ?>;
    ...
    montantInput.addEventListener('input', function() {
        const min = <?php echo e($plan->montant_min); ?>;
        const max = <?php echo e($plan->montant_max); ?>;
...
<?php echo $__env->make('layouts.adherent-modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Mes Sites Web\sif-project\resources\views/adherent/plans/show.blade.php ENDPATH**/ ?>
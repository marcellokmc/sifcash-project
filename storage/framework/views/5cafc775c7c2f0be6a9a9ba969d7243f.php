...
<?php $__env->startSection('page-title', 'Créer un Nouvel Utilisateur'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               id="matricule" name="matricule" value="<?php echo e(old('matricule')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                               id="date_embauche" name="date_embauche" value="<?php echo e(old('date_embauche')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="agence_id" name="agence_id">
                            ...
                            <?php $__currentLoopData = $agences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($agence->id); ?>" <?php echo e(old('agence_id') == $agence->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('backoffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Mes Sites Web\sif-project\resources\views/backoffice/users/create.blade.php ENDPATH**/ ?>
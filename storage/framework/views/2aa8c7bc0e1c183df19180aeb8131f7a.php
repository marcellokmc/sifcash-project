...
<?php $__env->startSection('title', 'Toutes mes activités'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="<?php echo e(route('adherent.dashboard')); ?>" class="btn btn-primary">
...
<div class="row" id="activitiesList">
    <?php if($toutesActivites->count() > 0): ?>
        <?php $__currentLoopData = $toutesActivites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-12 mb-3 activity-item" 
                 data-type="<?php echo e($activite['type']); ?>" 
                 data-date="<?php echo e($activite['date']->format('Y-m-d')); ?>"
                 data-search="<?php echo e(strtolower($activite['searchable'])); ?>">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-start">
                            <div class="bg-<?php echo e($activite['color']); ?> rounded-circle p-3 me-3 flex-shrink-0" style="width: 50px; height: 50px;">
                                <i class="<?php echo e($activite['icon']); ?> text-white"></i>
                            </div>
                            <div class="flex-grow-1 min-w-0">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <h6 class="mb-0 fw-bold text-truncate me-3"><?php echo e($activite['action']); ?></h6>
                                    <div class="text-end flex-shrink-0">
                                        <span class="badge bg-<?php echo e($activite['color']); ?> bg-opacity-25 text-<?php echo e($activite['color']); ?> mb-1">
                                            <?php echo e(ucfirst($activite['type'])); ?>

                                        </span>
                                        <br>
                                        <small class="text-muted">
                                            <i class="fas fa-clock me-1"></i>
                                            <?php echo e($activite['date']->format('d/m/Y H:i')); ?>

                                        </small>
                                    </div>
                                </div>
                                <p class="mb-1 text-dark"><?php echo e($activite['description']); ?></p>
                                <small class="text-muted"><?php echo e($activite['details']); ?></small>
                                
                                <?php if($activite['type'] === 'notification'): ?>
                                    ...
                                    <div class="mt-3 p-3 bg-light rounded">
                                        ...
                                        <p class="mb-2"><?php echo e($activite['message_complet'] ?? $activite['description']); ?></p>
                                        <?php if(!$activite['lu']): ?>
                                            <form method="POST" action="<?php echo e(route('adherent.notifications.mark-read', $activite['notification_id'])); ?>" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mt-2">
                                    <span class="badge bg-<?php echo e($activite['color']); ?>"><?php echo e(ucfirst($activite['statut'])); ?></span>
        ...
        <div class="col-12">
            <div class="text-center py-5">
                ...
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <a href="<?php echo e(route('adherent.dashboard')); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row text-center">
                        <div class="col-md-4 col-6 mb-3">
                            <div class="fw-bold text-success fs-4"><?php echo e($toutesActivites->where('type', 'paiement')->count()); ?></div>
                            <small class="text-muted">Paiements</small>
                        </div>
                        <div class="col-md-4 col-6 mb-3">
                            <div class="fw-bold text-warning fs-4"><?php echo e($toutesActivites->where('type', 'credit')->count()); ?></div>
                            <small class="text-muted">Crédits</small>
                        </div>
                        <div class="col-md-4 col-6 mb-3">
                            <div class="fw-bold text-info fs-4"><?php echo e($toutesActivites->where('type', 'retrait')->count()); ?></div>
                            <small class="text-muted">Retraits</small>
                        </div>
                        <div class="col-md-4 col-6 mb-3">
                            <div class="fw-bold text-secondary fs-4"><?php echo e($toutesActivites->where('type', 'document')->count()); ?></div>
                            <small class="text-muted">Documents</small>
                        </div>
                        <div class="col-md-4 col-6 mb-3">
                            <div class="fw-bold" style="color: #a855f7; font-size: 1.25rem;"><?php echo e($toutesActivites->where('type', 'ayant_droit')->count()); ?></div>
                            <small class="text-muted">Ayants Droit</small>
                        </div>
                        <div class="col-md-4 col-6 mb-3">
                            <div class="fw-bold text-primary fs-4"><?php echo e($toutesActivites->where('type', 'adhesion')->count()); ?></div>
        ...
        <div class="col-lg-4">
            <div class="card bg-primary text-white">
                <div class="card-body p-4 text-center">
                    ...
                    <h3 class="fw-bold"><?php echo e($toutesActivites->where('type', 'notification')->count()); ?></h3>
                    ...
                    <?php if($notificationsNonLues > 0): ?>
                        <span class="badge bg-danger">
                            <?php echo e($notificationsNonLues); ?> non lue<?php echo e($notificationsNonLues > 1 ? 's' : ''); ?>
...
<?php echo $__env->make('layouts.adherent-modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Mes Sites Web\sif-project\resources\views/adherent/notifications/index.blade.php ENDPATH**/ ?>
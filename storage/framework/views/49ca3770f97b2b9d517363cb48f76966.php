...
<?php $__env->startSection('title', '📊 Logs de Connexions - SIF Admin'); ?>
<?php $__env->startSection('page-title', '📊 Journaux de Connexion'); ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="lead mb-0" style="opacity: 0.9;">
                    🔍 Monitoring et analyse des connexions utilisateurs - <?php echo e(now()->format('d/m/Y')); ?>
            ...
            <div class="col-lg-4 text-end">
                <div class="d-flex align-items-center justify-content-end gap-3">
                    <div class="text-center">
                        <div class="h4 fw-bold mb-0"><?php echo e($stats['today_logins'] ?? 0); ?></div>
                        <small style="opacity: 0.8;">📅 Aujourd'hui</small>
                    </div>
                    <div class="text-center">
                        <div class="h4 fw-bold mb-0"><?php echo e($logs->total()); ?></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="modern-stat-card success">
            <div class="card-body p-4 text-center">
                ...
                <h2 class="fw-bold mb-1" style="color: #11998e;"><?php echo e(number_format($stats['successful_logins'] ?? 0)); ?></h2>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="modern-stat-card danger">
            <div class="card-body p-4 text-center">
                ...
                <h2 class="fw-bold mb-1" style="color: #ef4444;"><?php echo e(number_format($stats['failed_logins'] ?? 0)); ?></h2>
                <h6 class="text-muted mb-2">❌ Échecs de Connexion</h6>
                <div class="progress" style="height: 6px;">
                    <div class="progress-bar" style="width: <?php echo e(min(($stats['failed_logins'] ?? 0) * 2, 100)); ?>%; background: linear-gradient(135deg, #ef4444 0%, #f87171 100%);"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="modern-stat-card info">
            <div class="card-body p-4 text-center">
                ...
                <h2 class="fw-bold mb-1" style="color: #06b6d4;"><?php echo e(number_format($stats['logouts'] ?? 0)); ?></h2>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="modern-stat-card primary">
            <div class="card-body p-4 text-center">
                ...
                <h2 class="fw-bold mb-1" style="color: #667eea;"><?php echo e(number_format($stats['active_users'] ?? 0)); ?></h2>
            ...
            <div class="row align-items-center mb-3">
                ...
                <div class="col-md-4 text-end">
                    <div class="d-flex align-items-center justify-content-end gap-2">
                        <span class="text-muted">📋 <?php echo e($logs->total()); ?> entrées</span>
                        ...
                        <a href="<?php echo e(route('admin.logs.connexions.export', request()->query())); ?>" class="btn btn-sm btn-outline-info rounded-pill">
            ...
            <div id="advancedFilters" class="row g-3" style="display: none;">
                ...
                <div class="col-md-2">
                    ...
                    <select name="action" class="form-select form-select-sm">
                        ...
                        <option value="login" <?php echo e(request('action') == 'login' ? 'selected' : ''); ?>>🔓 Connexion</option>
                        <option value="logout" <?php echo e(request('action') == 'logout' ? 'selected' : ''); ?>>🚪 Déconnexion</option>
                        <option value="failed_login" <?php echo e(request('action') == 'failed_login' ? 'selected' : ''); ?>>❌ Échec</option>
                    </select>
                </div>
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <?php if(request()->anyFilled(['search', 'user_id', 'action', 'date_from', 'date_to'])): ?>
                        <a href="<?php echo e(route('admin.logs.connexions')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
            ...
            <div class="col-md-4 text-end">
                <div class="d-flex gap-2 justify-content-end">
                    <span class="badge bg-light text-dark px-3 py-2">
                        <i class="fas fa-clock me-1"></i><?php echo e(now()->format('H:i')); ?>

                    </span>
                    <span class="badge bg-light text-dark px-3 py-2">
                        <i class="fas fa-calendar me-1"></i><?php echo e(now()->format('d/m')); ?>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                ?>
                                <div class="user-avatar" style="background: <?php echo e($color); ?>;">
                                    <?php echo e(strtoupper(substr($userName, 0, 2))); ?>

                                </div>
                                <div>
                                    <?php if($log->user): ?>
                                        <a href="<?php echo e(route('admin.users.show', $log->user->id)); ?>" class="fw-semibold text-dark text-decoration-none" style="transition: color 0.3s;" onmouseover="this.style.color='#667eea'" onmouseout="this.style.color='#333'">
                                            <?php echo e($userName); ?>

                                        </a>
                                    <?php else: ?>
                                        <div class="fw-semibold text-muted"><?php echo e($userName); ?></div>
                                    <?php endif; ?>
                                    <small class="text-muted">
                                        <i class="fas fa-envelope me-1"></i><?php echo e(Str::limit($userEmail, 25)); ?>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                ?>
                                <i class="<?php echo e($browserIcon); ?> text-muted me-2"></i>
                                <span class="text-muted" style="font-size: 0.875rem;">
                                    <?php echo e(Str::limit($log->user_agent ?? '🌐 Navigateur inconnu', 35)); ?>
                        ...
                        <td>
                            <div class="text-center">
                                ...
                                <small class="text-muted">
                                    <i class="fas fa-clock me-1"></i><?php echo e($log->created_at->format('H:i:s')); ?>
                        ...
                        <td>
                            <div class="text-center">
                                <?php if($log->success ?? ($log->action == 'login')): ?>
                        ...
                        <td colspan="6">
                            <div class="text-center py-5">
                                ...
                                <?php if(request('search')): ?>
                                    <a href="<?php echo e(url()->current()); ?>" class="btn btn-outline-primary rounded-pill px-4">
...
<div class="mt-4 p-4 bg-white rounded-3 shadow-sm">
    <?php echo e($logs->links('custom-pagination')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    const hasActiveFilters = <?php echo e(request()->anyFilled(['user_id', 'action', 'date_from', 'date_to']) ? 'true' : 'false'); ?>;
    if (hasActiveFilters) {
...
<?php echo $__env->make('backoffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Mes Sites Web\projet sifcash final\sif-project\resources\views/backoffice/logs/connexions.blade.php ENDPATH**/ ?>
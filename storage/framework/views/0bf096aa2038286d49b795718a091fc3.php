...
<?php $__env->startSection('title', 'Mes Demandes de Retrait'); ?>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('adherent.retraits.create')); ?>" class="btn btn-primary">
                        ...
                        <table class="table table-centered table-striped dt-responsive nowrap w-100" id="retraits-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="<?php echo e(route('adherent.retraits.show', $retrait)); ?>" class="btn btn-sm btn-outline-primary">
                                                <i class="mdi mdi-eye"></i>
                                            </a>
                                            <?php if($retrait->statut === 'en_attente'): ?>
                                            <button type="button" class="btn btn-sm btn-outline-danger"
                                                    onclick="cancelRetrait(<?php echo e($retrait->id); ?>)" title="Annuler">
...
<?php echo $__env->make('layouts.adherent-modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Mes Sites Web\sif-project\resources\views/adherent/retraits/index.blade.php ENDPATH**/ ?>
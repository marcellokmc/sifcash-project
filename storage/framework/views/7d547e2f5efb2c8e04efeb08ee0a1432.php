...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="text-center">
                                <p class="mb-3 text-muted small">Vous êtes un adhérent ?</p>
                                <a href="<?php echo e(route('adherent.login')); ?>" class="adherent-link w-100 text-center d-block">
                                    <i class="fas fa-users me-2"></i>Accès Espace Adhérent
                                </a>
                            </div>
...
<?php /**PATH C:\Mes Sites Web\sif-project\resources\views/auth/login.blade.php ENDPATH**/ ?>
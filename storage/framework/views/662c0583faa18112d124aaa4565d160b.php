...
<head>
    <meta charset="utf-8">
    <title>Contrat d'Adhésion - <?php echo e($adherent->membre_id); ?></title>
    <style>
        body {
...
<body>
    <!-- En-tête -->
    <div class="header">
        <img src="<?php echo e(public_path('img/SIF logo .jpg')); ?>" alt="SIFcash-Burkina" class="logo-img">
            ...
            <div class="column">
                <table class="info-table">
                    <tr>
                        ...
                        <td class="value"><strong><?php echo e($adherent->membre_id); ?></strong></td>
                    </tr>
                    <tr>
                        <td class="label">Date d'adhésion :</td>
                        <td class="value"><strong><?php echo e($adherent->created_at->format('d/m/Y')); ?></strong></td>
                    </tr>
                    <tr>
                        <td class="label">Date d'activation :</td>
                        <td class="value">
                            <?php if($adherent->date_activation): ?>
                                <?php echo e($adherent->date_activation->format('d/m/Y H:i')); ?>
            ...
            <div class="column">
                <table class="info-table">
                    <tr>
                        ...
                        <td class="value">
                            <?php if($adherent->agence): ?>
                                <strong><?php echo e($adherent->agence->nom); ?></strong><br>
                                <small><?php echo e($adherent->agence->ville ?? $adherent->agence->departement); ?></small>
                            <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td class="value">
                            <?php if($adherent->agence): ?>
                                <strong><?php echo e($adherent->agence->code ?? 'N/A'); ?></strong>
                            <?php else: ?>
                                <span class="badge warning">Non affecté</span>
                            <?php endif; ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="value">
                            <?php if($adherent->agence && $adherent->agence->contact): ?>
                                <?php echo e($adherent->agence->contact); ?>
            ...
            <div class="column">
                <table class="info-table">
                    <tr>
                        ...
                        <td class="value"><?php echo e($adherent->nom_complet); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Date de naissance :</td>
                        <td class="value"><?php echo e($adherent->date_naissance->format('d/m/Y')); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Lieu de naissance :</td>
                        <td class="value"><?php echo e($adherent->lieu_naissance); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Situation familiale :</td>
                        <td class="value"><?php echo e(ucfirst($adherent->situation_famille)); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Profession :</td>
                        <td class="value"><?php echo e($adherent->profession); ?></td>
                    </tr>
                </table>
            </div>
            <div class="column">
                <table class="info-table">
                    <tr>
                        ...
                        <td class="value"><?php echo e($adherent->telephone); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Téléphone secondaire :</td>
                        <td class="value"><?php echo e($adherent->telephone_secondaire ?? 'Non renseigné'); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Email :</td>
                        <td class="value"><?php echo e($adherent->email); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Adresse :</td>
                        <td class="value"><?php echo e($adherent->adresse); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Résidence :</td>
                        <td class="value"><?php echo e($adherent->residence); ?></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="column">
                ...
                <table class="info-table">
                    <tr>
                        ...
                        <td class="value"><?php echo e($adherent->contact_urgence_nom ?? 'Non renseigné'); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Lien :</td>
                        <td class="value"><?php echo e(ucfirst($adherent->contact_urgence_lien_parente ?? 'Non renseigné')); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Téléphone :</td>
                        <td class="value"><?php echo e($adherent->contact_urgence_telephone ?? 'Non renseigné'); ?></td>
                    </tr>
                </table>
            </div>
            <div class="column">
                ...
                <table class="info-table">
                    <tr>
                        <td class="label">Nom :</td>
                        <td class="value"><?php echo e($adherent->contact_urgence_secondaire_nom ?? 'Non renseigné'); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Lien :</td>
                        <td class="value"><?php echo e(ucfirst($adherent->contact_urgence_secondaire_lien_parente ?? 'Non renseigné')); ?></td>
                    </tr>
                    <tr>
                        <td class="label">Téléphone :</td>
                        <td class="value"><?php echo e($adherent->contact_urgence_secondaire_telephone ?? 'Non renseigné'); ?></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <div class="section">
        ...
        <table class="info-table">
            <tr>
                ...
                <td class="value"><strong><?php echo e($adhesion->plan->nom ?? 'Plan non défini'); ?></strong></td>
            </tr>
            <tr>
                <td class="label">Date d'adhésion :</td>
                <td class="value"><?php echo e($adhesion->created_at->format('d/m/Y')); ?></td>
            </tr>
            <tr>
                ...
                <td class="value">
                    ...
                    <?php else: ?>
                        <span class="badge"><?php echo e(ucfirst($adhesion->statut)); ?></span>
                    <?php endif; ?>
                </td>
            </tr>
        </table>
    ...
    <div class="section">
        ...
        <div class="important">
            <strong>Article 1 - Objet du contrat :</strong> Le présent contrat définit les conditions d'adhésion de <?php echo e($adherent->nom_complet); ?> à la Société d'Investissement Financier (SIFCash-Burkina).
        </div>
    ...
    <div class="signature-section">
        <div class="signature-box">
            ...
            <p><?php echo e($adherent->nom_complet); ?></p>
    ...
    <div class="footer">
        ...
        Contrat d'Adhésion - Membre <?php echo e($adherent->membre_id); ?> - Généré le <?php echo e(now()->format('d/m/Y à H:i')); ?>

    </div>
</body>
</html><?php /**PATH C:\Mes Sites Web\sif-project\resources\views/pdf/contrat-adhesion.blade.php ENDPATH**/ ?>
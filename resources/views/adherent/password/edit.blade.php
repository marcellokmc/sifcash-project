        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('adherent.password.update') }}" id="passwordForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('adherent.profile') }}" class="btn btn-outline-secondary">

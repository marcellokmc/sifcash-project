...
@section('title', 'Tableau de Bord Adhérent')
                ...
                <div class="d-flex justify-content-between align-items-center position-relative">
                    <div>
                        <h1 class="display-5 fw-bold mb-2 text-dark">
                            🎆 Bienvenue, {{ $user->prenom ?? 'Adhérent' }} !
                        </h1>
                        ...
                        @elseif($adherent && $adherent->isEnAttente())
                            <div class="mt-2">
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <a href="{{ route('adherent.profile') }}" class="btn btn-outline-dark btn-lg">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-end">
                            <h2 class="mb-0 fw-bold text-primary">
                                {{ number_format($adherent->solde_epargne ?? 0, 0, ',', ' ') }}
                            </h2>
            ...
            <div class="card sif-stat-card success h-100 sif-bounce">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-end">
                            <h2 class="mb-0 fw-bold text-success">
                                {{ $adherent && $adherent->credits ? $adherent->credits->where('statut', 'approuvé')->count() : 0 }}
                            </h2>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="progress mt-2" style="height: 4px;">
                            <div class="progress-bar bg-success" style="width: {{ $adherent && $adherent->credits && $adherent->credits->where('statut', 'approuvé')->count() > 0 ? '100' : '0' }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card sif-stat-card info h-100 sif-float" style="animation-delay: 1s;">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-end">
                            <h2 class="mb-0 fw-bold text-info">
                                {{ $adherent && $adherent->ayantsDroit ? $adherent->ayantsDroit->count() : 0 }}
                            </h2>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="progress mt-2" style="height: 4px;">
                            <div class="progress-bar bg-info" style="width: {{ $adherent && $adherent->ayantsDroit && $adherent->ayantsDroit->count() > 0 ? min($adherent->ayantsDroit->count() * 25, 100) : '5' }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card sif-stat-card warning h-100 sif-shimmer">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-end">
                            <h2 class="mb-0 fw-bold text-warning">
                                {{ $validatedRequiredCount }}/{{ $requiredTypesCount }}
                            </h2>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="progress mt-2" style="height: 4px;">
                            <div class="progress-bar bg-warning" style="width: {{ $requiredTypesCount > 0 ? ($validatedRequiredCount / $requiredTypesCount) * 100 : '0' }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-3 col-sm-6">
                            <a href="{{ route('adherent.paiements.create') }}" class="sif-quick-action text-center position-relative overflow-hidden">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <a href="{{ route('adherent.credits.create') }}" class="sif-quick-action text-center position-relative overflow-hidden">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <a href="{{ route('adherent.retraits.create') }}" class="sif-quick-action text-center position-relative overflow-hidden">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <a href="{{ route('adherent.ayants-droit.create') }}" class="sif-quick-action text-center position-relative overflow-hidden">
                    ...
                    <div class="mt-4 pt-3 border-top">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="{{ route('adherent.contrat.download') }}" class="btn btn-success w-100">
                                    <i class="fas fa-file-pdf me-2"></i>Télécharger mon contrat
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a href="{{ route('adherent.adhesions.index') }}" class="btn btn-info w-100">
                ...
                <div class="card-body p-4">
                    ...
                    @if($activitesRecentes->count() > 0)
                        <div class="timeline">
                            @foreach($activitesRecentes as $activite)
                                <div class="d-flex align-items-start mb-3 {{ !$loop->last ? 'pb-3 border-bottom border-light' : '' }}">
                                    <div class="bg-{{ $activite['color'] }} rounded-circle p-2 me-3 flex-shrink-0" style="width: 40px; height: 40px;">
                                        <i class="{{ $activite['icon'] }} text-white" style="font-size: 0.9rem;"></i>
                                    </div>
                                    <div class="flex-grow-1 min-w-0">
                                        <h6 class="mb-1 fw-semibold">{{ $activite['action'] }}</h6>
                                        <p class="mb-1 small text-muted">{{ $activite['description'] }}</p>
                            ...
                            <div class="text-center pt-3 mt-2 border-top">
                                <a href="{{ route('adherent.notifications.index') }}" class="btn btn-sm btn-outline-primary">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <div class="mt-3">
                                <a href="{{ route('adherent.paiements.create') }}" class="btn btn-sm btn-primary me-2">
                                    <i class="fas fa-plus me-1"></i>Premier versement
                                </a>
                                <a href="{{ route('adherent.notifications.index') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="card-body p-4 position-relative">
                    <div class="row g-3">
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="{{ route('cgu') }}" class="btn btn-light w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3 text-decoration-none">
                                <i class="fas fa-file-contract text-primary mb-2" style="font-size: 1.5rem;"></i>
                                <small class="fw-bold text-dark">📋 CGU</small>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="{{ route('data-protection') }}" class="btn btn-light w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3 text-decoration-none">
                        ...
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="{{ route('about') }}" class="btn btn-light w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3 text-decoration-none">
                                <i class="fas fa-building text-info mb-2" style="font-size: 1.5rem;"></i>
                                <small class="fw-bold text-dark">🏢 À Propos</small>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                            <a href="{{ route('privacy') }}" class="btn btn-light w-100 h-100 d-flex flex-column align-items-center justify-content-center p-3 text-decoration-none">
        ...
        <div class="col-12">
            <div class="card sif-card sif-card-success">
                <div class="sif-card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="text-end">
                        <h3 class="mb-0 text-white fw-bold">{{ round($completionProfil) }}%</h3>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="sif-progress mb-4">
                        <div class="sif-progress-bar success" 
                             style="width: {{ $completionProfil }}%" 
                             role="progressbar" 
                             aria-valuenow="{{ $completionProfil }}" 
                             aria-valuemin="0" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="list-group list-group-flush">
                                ...
                                @endif
                                @if($validatedRequiredCount < $requiredTypesCount)
                                    <div class="list-group-item px-0 py-2 border-0">
                                        <i class="fas fa-circle-notch text-warning me-2"></i>
                                        Documents obligatoires ({{ $requiredTypesCount - $validatedRequiredCount }} manquants)
                                    </div>
                                @endif
                                @if($completionProfil >= 100)
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-grid gap-2">
                                <a href="{{ route('adherent.profile.edit') }}" class="btn btn-primary">
                                    <i class="fas fa-user-edit me-2"></i>Compléter mon profil
                                </a>
                                @if($validatedRequiredCount < $requiredTypesCount)
                                    <a href="{{ route('adherent.documents.create') }}" class="btn btn-outline-primary">

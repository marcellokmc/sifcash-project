    ...
    <div class="d-flex">
        ...
        <nav id="sidebar" class="sidebar d-flex flex-column">
            ...
            <ul class="nav flex-column flex-grow-1">
                ...
                <!-- Profil -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('adherent.profile.*') ? 'active' : '' }}" 
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('adherent.password.*') ? 'active' : '' }}" 
                       href="{{ route('adherent.password.edit') }}">
                ...
                <!-- Plans disponibles -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('adherent.plans.*') ? 'active' : '' }}" 
                ...
                <!-- Mes adhésions -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('adherent.adhesions.*') ? 'active' : '' }}" 
                       href="{{ route('adherent.adhesions.index') }}">
                        ...
                        @if($nbAdhesionsActives > 0)
                            <span class="badge bg-success ms-auto">{{ $nbAdhesionsActives }}</span>
                        @endif
                    </a>
                </li>
                ...
                <!-- Épargne -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('adherent.paiements.*') ? 'active' : '' }}" 
                       href="{{ route('adherent.paiements.index') }}">
                ...
                <!-- Crédits -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('adherent.credits.*') ? 'active' : '' }}" 
                       href="{{ route('adherent.credits.index') }}">
                        ...
                        @if($nbCreditsEnAttente > 0)
                            <span class="badge bg-warning ms-auto">{{ $nbCreditsEnAttente }}</span>
                        @endif
                    </a>
                </li>
                ...
                <!-- Retraits -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('adherent.retraits.*') ? 'active' : '' }}" 
                       href="{{ route('adherent.retraits.index') }}">
                ...
                <!-- Ayants droit -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('adherent.ayants-droit.*') ? 'active' : '' }}" 
                ...
                <!-- Notifications -->
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('adherent.notifications.*') ? 'active' : '' }}" 
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-nav ms-auto d-flex flex-row align-items-center">
                        ...
                        <div class="nav-item dropdown me-3">
                            <a class="nav-link btn btn-outline-primary btn-sm" href="{{ route('adherent.adhesions.create') }}">
                        ...
                        <!-- Notifications -->
                        <div class="nav-item dropdown me-3">
                            <a class="nav-link position-relative" href="{{ route('adherent.notifications.index') }}">
                                <i class="fas fa-bell fs-5"></i>
                                @if($nbNotificationsNonLues > 0)
                                    <span class="notification-badge">{{ $nbNotificationsNonLues }}</span>
                                @endif
                            </a>
                        </div>

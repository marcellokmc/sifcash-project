{{-- Modals pour la gestion des comptes utilisateurs et adhérents --}}
...
{{-- Modal: Afficher le nouveau mot de passe --}}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @if(session('new_password'))
        document.getElementById('displayNewPassword').textContent = '{{ session("new_password") }}';
        @if(session('user_email'))
            document.getElementById('emailSentInfo').classList.remove('d-none');
            document.getElementById('userEmailSent').textContent = '{{ session("user_email") }}';
        @endif

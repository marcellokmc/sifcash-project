                ...
                <div class="error-card p-4 p-md-5 text-center">
                    ...
                    <div class="alert alert-light border-0 mb-4">
                        <small class="text-muted">
                            ...
                            <code class="text-danger">{{ request()->fullUrl() }}</code>
                        </small>
                    </div>
                    @endif
                    ...
                    <div class="mt-5 pt-4 border-top">
                        ...
                        <div class="row g-2">
                            ...
                            @auth
                                ...
                                <div class="col-6 col-md-3">
                                    <a href="{{ route('admin.adherents.index') }}" class="btn btn-outline-primary btn-sm w-100">
                                        <i class="fas fa-users d-block mb-1"></i>
                                        <small>Adhérents</small>
                                    </a>
                                </div>
                                <div class="col-6 col-md-3">
                                    <a href="{{ route('admin.credits.index') }}" class="btn btn-outline-primary btn-sm w-100">
                                ...
                                <div class="col-6 col-md-3">
                                    <a href="{{ route('adherent.credits.index') }}" class="btn btn-outline-primary btn-sm w-100">
                                        <i class="fas fa-credit-card d-block mb-1"></i>

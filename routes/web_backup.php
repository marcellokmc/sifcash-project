...
// Authentification adh̩rent (email ou t̩l̩phone)
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:adherent'])->prefix('adherent')->name('adherent.')->group(function () {
        ...
        // Inscription (workflow ̩tape par ̩tape)
        ...
        // Cr̩dits (gestion par l'adh̩rent)
        ...
        // Cr̩dits (lecture par l'adh̩rent)
        ...
        // Paiements de cr̩dit (Espace adh̩rent)
    ...
    Route::middleware(['role:admin,agent,chef_service'])->prefix('admin')->name('admin.')->group(function () {
        ...
        // T̩l̩chargement/Visionnage des documents (admin)
        Route::get('documents/{document}/download/{type?}', [DocumentController::class, 'download'])->name('documents.download');
        ...
        // Cr̩dit: g̩n̩ration d'̩ch̩ancier
        ...
        // Paiements de cr̩dit (Backoffice admin)
        ...
        // Conditions d'̩ligibilit̩ cr̩dit
        ...
        // Gestion des r̫les et permissions (Admin seulement)
        Route::middleware(['role:admin'])->group(function () {
        ...
        // Gestion des p̩nalit̩s de retrait anticip̩
